...
if (!$irVismaz8 || !$irLielaisBurts || !$irCipars || !$irSpecialaRakstzime || !$navAtstarpes) {
        die('Parolei jābūt vismaz 8 rakstzīmēm, tajā jābūt 1 lielajam burtam, 1 ciparam un 1 speciālajai rakstzīmei, un tajā nedrīkst būt atstarpes.');
}
